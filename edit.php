...
if(isset($_REQUEST['id'])){
    ...
    $editsqli  = "SELECT * FROM reginfo WHERE ID = $editId";
...
if(isset($_REQUEST['update'])){
    ...
    $updateSqli   = "UPDATE reginfo SET Full_Name='$fullname', Email='$email', Position='$postion', Password='$password', Gender='$gender' WHERE ID = $editId ";
